const en = {
    ...
    add: 'Add',
    createAccountGroup: 'New Group',
    inputAccountGroupName: 'Enter group name',
    accountGroupNameLimit: 'Name length must be 1-30 characters',
    accountGroupCreated: 'Created group: {msg}',
